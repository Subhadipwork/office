            ...
            <div class="col-12">
                <div class="card">
                    ...
                    @endif
                        ...
                        {{-- flash massage end --}}
                        <form action="{{ route('project.store') }}" method="POST" id="form_id" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control @error('clind') is-invalid @enderror" id="clind" value="{{ old('clind') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="clind" class="form-label">Clind Name</label>
                                        <input type="text" name="client_name" class="form-control @error('clind') is-invalid @enderror" id="clind" value="{{ old('client_name') }}">
                                    </div>
                                </div>
        ...
        $('.add_more').click(function () {
            var addMoreDetails = `<div class="row addmore">
                ...
                <div class="col-lg-3">
                    ...
                    <img id="preview-image-before-upload-${i}" src="" alt="" class="img-fluid">
                </div>
                <div class="col-lg-3">

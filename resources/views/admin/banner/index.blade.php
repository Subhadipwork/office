                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered nowrap custom_table"
                                    ...
                                    @if ($items->isNotEmpty())
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-danger btn-sm delete" data-id="{{ $item->id }}" data-url="{{ route('banner.destroy', $item->id) }}">Delete</a>
                                                </td>

                        ...
                        <form action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-6 mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="blog_title" id="blog-name" placeholder="Blog Name" value="{{$blog->blog_title}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="blog_author" id="author-name" placeholder="Author Name" required value="{{$blog->blog_author}}">
                                    </div>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-10">
                                       <textarea name="blog_description" id="ckeditor" cols="40" rows="10">{{$blog->blog_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img id="blah" src="{{ asset('uploads/blogs/' . $blog->blog_image) }}" style="width: 100px;">
                                    </div>
                                </div>
                                </div>
                            </div>

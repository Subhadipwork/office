                    ...
                    @endif
                        ...
                        <form action="{{ route('product.store') }}" method="POST" id="form_id" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="subcategory" class="form-label">MRP Price</label>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea name="short_description" id="editor" rows="">{{ old('short_description') }}</textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea name="specification" id="editor3" rows="">{{ old('specification') }}</textarea>
                                                        </div>
                                                    </div>

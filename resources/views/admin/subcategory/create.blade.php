            ...
            <div class="col-12">
                ...
                @endif
                  ...
                  {{-- flash massage end --}}
                        ...
                        <form action="{{ route('subcategory.store') }}" method="POST" id="form_id" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="subcategory-name" placeholder="Enter Subcategory Name" required value="{{ old('name') }}">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
